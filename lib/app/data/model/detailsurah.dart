...
class PreBismillah {
  ...
  PreBismillah.fromJson(Map<String, dynamic> json) {
    text = json['text'] != null
        ? new TextDetailSurah.fromJson(json['text'])
        : null;
    translation = json['translation'] != null
        ? new Transliteration.fromJson(json['translation'])
        : null;
...
class TextDetailSurah {
  ...
  TextDetailSurah({this.arab, this.transliteration});

  TextDetailSurah.fromJson(Map<String, dynamic> json) {
    arab = json['arab'];
    transliteration = json['transliteration'] != null
        ? new Transliteration.fromJson(json['transliteration'])
        : null;
