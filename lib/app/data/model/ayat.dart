class Ayat {
  ...
  Ayat.fromJson(Map<String, dynamic> json) {
    ...
    textAyat = json['textAyat'] != null
        ? new TextAyat.fromJson(json['textAyat'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.textAyat != null) {
      data['textAyat'] = this.textAyat!.toJson();
    }
...
class TextAyat {
  ...
  TextAyat({this.arab, this.transliteration});

  TextAyat.fromJson(Map<String, dynamic> json) {
    arab = json['arab'];
